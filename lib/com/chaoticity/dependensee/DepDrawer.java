...
public class DepDrawer {
    private static TreebankLanguagePack tlp = new PennTreebankLanguagePack(); //this is only for English
    private static GrammaticalStructureFactory gsf = tlp.grammaticalStructureFactory();

    //change treebanck language pack
    public static void setTreebankLanguagePack(TreebankLanguagePack newTlp){
        DepDrawer.tlp = newTlp;
        DepDrawer.gsf = DepDrawer.tlp.grammaticalStructureFactory();
    }
